...
SOURCE_REVISION="${20:-unknown}"; SOURCE_DIRTY="${21:-unknown}"; SAMPLES_FILE="${22:-}"
...
OUTAGE="$OUTAGE" JAR_SHA="$JAR_SHA" JAR_BUILT_AT="$JAR_BUILT_AT" SOURCE_REVISION="$SOURCE_REVISION" SOURCE_DIRTY="$SOURCE_DIRTY" SAMPLES_FILE="$SAMPLES_FILE" \
